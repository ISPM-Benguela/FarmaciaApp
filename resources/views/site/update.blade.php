            ...
            <div class="container">
              <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <form action="{{ route('tualizar.quantidade', $produto->id) }}" method="POST">
                    @csrf
                  <div class="mb-5">
                    <div class="input-group mb-3" style="max-width: 220px;">
                      ...
                      <input type="text" class="form-control text-center" name="quantidade" value="{{ $carrinho->quantidade }}"  placeholder=""

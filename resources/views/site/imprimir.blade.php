          ...
          <div class="row content-panel">
            <div class="col-lg-10 col-lg-offset-1">
              <div class="invoice-body">
                ...
                <abbr title="Phone"> Atenção: Conservar bem este documento
              </address>
                </div>
                <!-- /pull-left -->
                ...
                <div class="row">
                  ...
                  <div class="col-md-3">
                    <br>
                    <div>
                      <div class="pull-left"> TIPO DE VENDA : </div>
  ...
  <script>
    $(document).ready(function(){
      $("#imprimir").click(function(){
        window.print();
        $.ajax({
          url: 'http://127.0.0.1:8000/admin/fechar-carrinho',
          method: 'GET',
          data: {imprimir: true },
          success: function(response){
            if(response.success){
              window.location.assign("http://127.0.0.1:8000/carrinho");
            }
          }
        })
      });

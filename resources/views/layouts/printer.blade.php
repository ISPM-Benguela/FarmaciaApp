              ...
              <div class="invoice-body">
                ...
                <div class="row">
                  <div class="col-md-9">
                    <h4>CLIENTE</h4>
                    <address>
                  <strong>{{ $cliente->user['name'] }}</strong><br>
                  Cliente desde<br>
                  {{ $cliente->user['created_at'] }}<br>
                </address>
                  </div>
                  <!-- /col-md-9 -->
                  <div class="col-md-3">
                    <br>
                    <div>
                      <div class="pull-left"> FATURA NO : </div>
                      <div class="pull-right"> {{ $cliente->id }}</div>
                      <div class="clearfix"></div>
                    </div>
                    <div>
                      <!-- /col-md-3 -->
                ...
                <table class="table">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="text-right">{{ $item->preco }} Kz</td>
                    </tr>
                    @endforeach
                    ...
                    <tr>
                      ...
                      <tr>
                        <td class="text-right no-border">
                          <div class="well well-small green"><strong>Troco</strong></div>
                        </td>
                        <td class="text-right"><strong>{{ $troco }} Kz</strong></td>
                      </tr>
  ...
  <script>
    $(document).ready(function(){
      $("#imprimir").click(function(){
        window.print();
        $.ajax({
          url: 'http://127.0.0.1:8000/admin/fechar-fatura',
          method: 'GET',
          data: {imprimir: true },
          success: function(response){
            if(response.success){
              window.location.assign("http://127.0.0.1:8000/admin/venda-balcao");
            }
          }
        })
      });
